...
-- 
-- newtype Participant = Participant Bech32
-- 
-- newtype Sponsor = Sponsor Bech32
-- --   deriving stock (Eq, Generic, Show)
-- --   deriving newtype (ToJSON, FromJSON)
-- 
-- newtype Oracle = Oracle Bech32
-- --  deriving stock (Eq, Generic, Show)
-- --  deriving newtype (ToJSON, FromJSON)
-- 
...
-- --  deriving newtype (ToJSON, FromJSON)
-- 
-- newtype PriceToken = PriceToken TokenName
-- 
-- raffle
--   :: Sponsor
--   -> Oracle
--   -> ChunkSize
--   -> NonEmptyArray Participant
--   -> NonEmptyArray PriceToken
--   -> Timeout
--   -> Timeout
--   -> Timeout
--   -> Contract
