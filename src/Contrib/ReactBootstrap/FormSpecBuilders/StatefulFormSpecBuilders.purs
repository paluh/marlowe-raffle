...
dateTimeField
  ...
  -> FormSpecBuilderT builderM (StatefulBootstrapFormSpec validatorM st) Query a
dateTimeField initial possibleLabel possibleHelpText dateTimeValidator = do
  FormSpecBuilder.hoistFormSpec liftStatelessFormSpec $ StatelessFormSpecBuilders.dateTimeField initial possibleLabel possibleHelpText dateTimeValidator
